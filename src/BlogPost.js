...
import Comment from './Comment.js';  // I added this
...
export default class BlogPost extends Component {
  render() {
    ...
    const comments = [
      "Whenever we speak we are afraid our words will not be heard or welcomed. But when we are silent, we are still afraid. So it is better to speak. - Audrey Lorde", 
